...
Aun siendo un sensor muy útil, que puede aumentar el nivel de redundancia del sistema, además de su seguridad, múltiples compañías como Tesla tratan de evitar su uso utilizando unicamente cámaras y \acs{radar}. Esto es debido a que un \acs{lidar} suele costar entre 8.000 y 100.000 dólares si se requiere de una resolución similar al estado del arte entre 16 y 128 haces \cite{computing_system_for_autonomous_driving}.
