...
De forma comparativa al algoritmo \acs{ransac}-3D, se genera un plano ajustándose a la mayoría de los puntos de la escena, anotando como inliers aquellos puntos pertenecientes al suelo y dejando el resto de puntos que colisionan con el entorno como outliers, por lo que dicho algoritmo \acs{ransac} es el utilizado para la tarea de filtrado de la sección de la nube de puntos que colisiona con el suelo de la escena.
