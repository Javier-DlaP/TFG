...
Perception systems in autonomous vehicles are those that allow to understand what is happening in the environment. This work focuses on the study of perception techniques using LiDAR technologies, both classical techniques and techniques based on Deep Learning. This study presents the implementations designed for the Techs4AgeCar project vehicle.\par
Along with the implementation based on a single sensor, a sensor fusion model between camera and LiDAR is also presented based on the detection system explained in this TFG and the camera-based work done by Miguel Antunes, a colleague of the RobeSafe research group.\par
