...
\begin{lstlisting}[language=bash]
cd ~/t4ac_ws/src/t4ac_architecture/t4ac_perception_layer/detection/lidar/t4ac_openpcdet_ros/src/
...
\begin{lstlisting}[language=bash]
cd ~/t4ac_ws/src/t4ac_carla_simulator/ad_devkit/src/perception/evaluator/
python evaluate.py
\end{lstlisting}
\end{enumerate}
\end{enumerate}
...
Los costes del hardware constan unicamente del valor del ordenador utilizado ya que al necesitar solo el vehículo T4AC para la extracción de datos se ha omitido su coste. Por otra parte, todo el software utilizado en el TFG ha sido Open Source por lo que no ha sido necesario ningún gasto.
...
\begin{table}[H]
	\begin{center}
		...
		\hline\hline
		Estudio de técnicas de detección e implementación de sistemas de detección& 6,5 meses & 12 horas/semana & 340 horas & 6.800 \euro \\ 
		\hline
		...
		\hline
		\hline
		\multicolumn{3}{|c|}{\textbf{TOTAL}}&797,5 horas&15.950 \euro \\
		\hline
		\end{tabular}
...
\begin{table}[H]
	\begin{center}
		...
		\hline
		Coste del personal & 15.950 \euro \\ 
		\hline
		\hline
		Coste bruto & 17.550 \euro \\
		\hline
		IVA (21 \%) & 3.685,5 \euro \\
		\hline
		\hline
		\textbf{TOTAL} & 21.235,5 \euro \\
		\hline
		\end{tabular}
...
El coste estimado por tanto del Trabajo Fin de Grado asciende a la cantidad de 17.550 \euro , que incluyendo el IVA aumenta a 21.235,5 \euro.
